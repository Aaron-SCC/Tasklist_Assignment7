...
public class TaskListDB {
    ...
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            db.execSQL("INSERT INTO list VALUES (2, 'Home')");
            db.execSQL("INSERT INTO list VALUES (3, 'Study')");

            
            // insert sample tasks
            db.execSQL("INSERT INTO task VALUES (1, 3, 'Get Stuff Done in Following Courses', " +
                    "'ITC162\nITC260\nPEC165', '0', '0')");
            db.execSQL("INSERT INTO task VALUES (2, 3, 'Read more from Atomic Habits book.', " +
                    "'', '0', '0')");
        }
